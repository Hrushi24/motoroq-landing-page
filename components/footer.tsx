    ...
    <footer className="bg-card border-t border-border">
      <div className="max-w-7xl mx-auto px-6 py-16">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 pt-2">
                <a
                  ...
                  className="p-2 text-[#25D366] hover:drop-shadow-[0_0_8px_rgba(37,211,102,0.6)] transition-all"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-2 text-[#E4405F] hover:drop-shadow-[0_0_8px_rgba(228,64,95,0.6)] transition-all"
        ...
        <div className="border-t border-border pt-8 flex justify-center items-center">
          <p className="text-muted-foreground text-sm">© 2025 motoroq. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
